...
function (
    ...
    ProjectedGrid.prototype.update = function (camera) {
        ...
        // source.set(0, 0);
        // this.getWorldIntersectionHomogenous(0.0, source, modelViewProjectionInverseMatrix, this.intersectBottomLeft);
        // source.set(0, 1);
        // this.getWorldIntersectionHomogenous(0.0, source, modelViewProjectionInverseMatrix, this.intersectTopLeft);
        // source.set(1, 1);
        // this.getWorldIntersectionHomogenous(0.0, source, modelViewProjectionInverseMatrix, this.intersectTopRight);
        // source.set(1, 0);
        // this.getWorldIntersectionHomogenous(0.0, source, modelViewProjectionInverseMatrix, this.intersectBottomRight);
        source.set(0.5, 0.5);
        ...
        // update data
        // TODO: send information to shader to do homogenous interpolation

        return true;
    };

	ProjectedGrid.prototype.getWorldIntersectionHomogenous = function (planeHeight, screenPosition,
			modelViewProjectionInverseMatrix, store) {
		this.calculateIntersection(planeHeight, screenPosition, modelViewProjectionInverseMatrix);
		store.setv(this.origin);
	};

	ProjectedGrid.prototype.getWorldIntersection = function (planeHeight, screenPosition,
			modelViewProjectionInverseMatrix, store) {
		this.calculateIntersection(planeHeight, screenPosition, modelViewProjectionInverseMatrix);
	...
	ProjectedGrid.prototype.getWorldIntersectionSimple = function (planeHeight, source, destination,
			store, tmpStorage) {
	...
	ProjectedGrid.prototype.calculateIntersection = function (planeHeight, screenPosition,

...
class Box extends MeshData {
	...
	constructor(width, height?, length?, tileX?, tileY?, textureMode?) {
		super(MeshData.defaultMap([MeshData.POSITION, MeshData.NORMAL, MeshData.TEXCOORD0]), 24, 36);
	 ...
	 */
	clone () {
		var options = ObjectUtils.shallowSelectiveClone(this, ['tileX', 'tileY', 'textureMode']) as any;

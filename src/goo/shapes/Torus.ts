...
class Torus extends MeshData {
	...
	constructor(circleSamples, radialSamples, tubeRadius, centerRadius) {
		var attributeMap = MeshData.defaultMap([MeshData.POSITION, MeshData.NORMAL, MeshData.TEXCOORD0]);
		var vertices = (circleSamples + 1) * (radialSamples + 1);
		var indices = 6 * circleSamples * radialSamples;
		super(attributeMap, vertices, indices);
	 ...
	 */
	clone() {
		return new Torus(this.circleSamples, this.radialSamples, this.tubeRadius, this.centerRadius);
	};
}

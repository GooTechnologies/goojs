...
define(['goo/loaders/handlers/ConfigHandler', 'goo/loaders/handlers/ComponentHandler', 'goo/loaders/Loader', 'goo/renderer/TextureCreator', 'goo/util/rsvp', 'goo/util/StringUtil', 'goo/util/PromiseUtil', 'goo/lib/underscore', 'goo/loaders/handlers/SceneHandler', 'goo/loaders/handlers/EntityHandler', 'goo/loaders/handlers/CameraComponentHandler', 'goo/loaders/handlers/LightComponentHandler', 'goo/loaders/handlers/MeshDataComponentHandler', 'goo/loaders/handlers/MeshRendererComponentHandler', 'goo/loaders/handlers/TransformComponentHandler'], function(ConfigHandler, ComponentHandler, Loader, TextureCreator, RSVP, su, pu) {
  /**
  ...
  return DynamicLoader = (function() {
    ...
    */
      ...
      return this._loadRef(ref).then(function(config) {
        ...
        _fn = function(childRef) {
          return promises.push(_this._loadRef(childRef).then(function(childConfig) {
            return _this._handle(childRef, childConfig, options);
          }));
        };
        ...
        promises.push(_this._handle(ref, config, options));
    ...
    DynamicLoader.prototype._handle = function(ref, config, options) {
      ...
      } else if (this._objects[ref] && !options.noCache) {

...
define(['goo/loaders/handlers/ConfigHandler', 'goo/loaders/handlers/ComponentHandler', 'goo/loaders/Loader', 'goo/entities/components/MeshRendererComponent', 'goo/entities/components/MeshDataComponent', 'goo/renderer/Material', 'goo/renderer/Util', 'goo/renderer/shaders/ShaderLib', 'goo/util/rsvp', 'goo/util/PromiseUtil', 'goo/util/ConsoleUtil', 'goo/lib/underscore'], function(ConfigHandler, ComponentHandler, Loader, MeshRendererComponent, MeshDataComponent, Material, Util, ShaderLib, RSVP, pu, console) {
  ...
  ShaderHandler = (function(_super) {
    ...
    function ShaderHandler() {
      _ref = ShaderHandler.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    ShaderHandler.prototype.update = function(ref, config) {
      ...
      return RSVP.all(promises).then(function(shaders) {
        var fshader, object, shaderDefinition, vshader, _ref1, _ref2;
        ...
        shaderDefinition = {
          attributes: (_ref1 = config.attributes) != null ? _ref1 : {},
          uniforms: (_ref2 = config.uniforms) != null ? _ref2 : {},
          vshader: vshader,
          fshader: fshader
        };
  ...
  return MeshRendererComponentHandler = (function(_super) {
    ...
    function MeshRendererComponentHandler() {
      _ref1 = MeshRendererComponentHandler.__super__.constructor.apply(this, arguments);
      return _ref1;
    }

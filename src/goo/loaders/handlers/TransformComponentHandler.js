...
define(['goo/loaders/handlers/ComponentHandler', 'goo/entities/components/TransformComponent', 'goo/math/MathUtils', 'goo/util/rsvp', 'goo/util/PromiseUtil', 'goo/util/ObjectUtil'], function(ComponentHandler, TransformComponent, MathUtils, RSVP, pu, _) {
  var TransformComponentHandler;
  return TransformComponentHandler = (function(_super) {
    ...
    function TransformComponentHandler() {
      return TransformComponentHandler.__super__.constructor.apply(this, arguments);
    }
      ...
      if (config.parentRef != null) {
        ...
        this.getConfig(config.parentRef).then(function(parentConfig) {
          return _this.updateObject(config.parentRef, parentConfig, _this.options).then(function(parent) {
            var _ref;
            if ((parent != null) && ((_ref = component.parentRef) != null ? _ref.entity : void 0) !== parent) {

...
define(['goo/loaders/handlers/ComponentHandler', 'goo/entities/components/LightComponent', 'goo/renderer/light/PointLight', 'goo/math/Vector', 'goo/util/rsvp', 'goo/util/PromiseUtil', 'goo/util/ObjectUtil'], function(ComponentHandler, LightComponent, PointLight, Vector, RSVP, pu, _) {
  var LightComponentHandler;
  return LightComponentHandler = (function(_super) {

    __extends(LightComponentHandler, _super);

    function LightComponentHandler() {
      return LightComponentHandler.__super__.constructor.apply(this, arguments);
    }

define([
	...
	GlobalRotationGizmo.prototype.process = function() {
	...
	GlobalRotationGizmo.prototype._rotateOnScreen = function(dx, dy) {
	...
	GlobalRotationGizmo.prototype._rotateOnAxis = function(dx, dy) {
		this._rotation.setIdentity();
	...
	GlobalRotationGizmo.prototype._buildBall = function() {
		...
		this.addRenderable({
			...
			id: Gizmo.registerHandle({ type: 'GlobalRotate', axis: 3 })
		});
	};

	GlobalRotationGizmo.prototype._buildTorus = function(dim) {
		var transform = new Transform();
		...
		this.addRenderable({
			...
			transform: transform,
			id: Gizmo.registerHandle({ type: 'GlobalRotate', axis: dim }),
			thickness: 0.35
		});
	};

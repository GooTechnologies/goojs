...
class Ajax {
	...
	static ENGINE_SHADER_PREFIX = 'GOO_ENGINE_SHADERS/';
	...
	static types = {
		...
		asset: addKeys(
			{},
			Object.keys(imageTypes).concat(Object.keys(binaryTypes))
		)
	};

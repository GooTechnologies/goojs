...
class ParticleSystemUtils {
	 ...
	 * @returns {Entity}
	 */
	static createParticleSystemEntity(world, particleParameters, material) {
	 ...
	 * @returns {Texture}
	 */
	static createFlareTexture(size, options?) {
		size = size || 64;
	 ...
	 * @returns {Texture}
	 */
	static createSplashTexture(size, options) {
		size = size || 64;
	 ...
	 * @returns {Texture}
	 */
	static createPlanktonTexture(size, options) {
		size = size || 64;
	 ...
	 * @returns {Texture}
	 */
	static createSnowflakeTexture(size, options) {
		size = size || 64;

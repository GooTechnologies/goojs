...
class Ray {
	 ...
	 */
	intersects(polygonVertices, doPlanar, locationStore, skipBackSide?) {
	 ...
	 */
	intersectsTriangle(pointA, pointB, pointC, doPlanar, locationStore, skipBackSide) {
	 ...
	 */
	getDistanceToPrimitive(worldVertices) {
		// Intersection test
	 ...
	 */
	intersectsPlane(plane, locationStore) {

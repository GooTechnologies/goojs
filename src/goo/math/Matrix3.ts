...
class Matrix3 extends Matrix {
	...
	static _tempX = new Vector3();
	static _tempY = new Vector3();
	static _tempZ = new Vector3();

	set e00(value){ this.data[0] = value; }
	set e10(value){ this.data[1] = value; }
	set e20(value){ this.data[2] = value; }
	set e01(value){ this.data[3] = value; }
	set e11(value){ this.data[4] = value; }
	set e21(value){ this.data[5] = value; }
	set e02(value){ this.data[6] = value; }
	set e12(value){ this.data[7] = value; }
	set e22(value){ this.data[8] = value; }

	get e00(){ return this.data[0]; }
	get e10(){ return this.data[1]; }
	get e20(){ return this.data[2]; }
	get e01(){ return this.data[3]; }
	get e11(){ return this.data[4]; }
	get e21(){ return this.data[5]; }
	get e02(){ return this.data[6]; }
	get e12(){ return this.data[7]; }
	get e22(){ return this.data[8]; }
	 ...
	 */
	multiplyDiagonalPost(vec, result) {
		var x = vec.x;
		var y = vec.y;
		var z = vec.z;
	 ...
	 */
	fromAngleNormalAxis(angle, x, y, z) {

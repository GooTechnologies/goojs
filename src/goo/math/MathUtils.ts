...
class MathUtils {
	 ...
	 * }
	 */
	static EPSILON = 0.00001; //! AT: unfortunately Matrix.invert is too unstable to use a smaller epsilon
	 ...
	 */
	static radialClamp(value, min, max) {
	 ...
	 */
	static moduloPositive(value, size) {
	 ...
	 */
	static getTriangleNormal(p1x, p1y, p1z, p2x, p2y, p2z, p3x, p3y, p3z) {
		var ux = p2x - p1x;
		var uy = p2y - p1y;
		var uz = p2z - p1z;
	 ...
	 * @returns {number} Nearest power of two
	 */
	static nearestHigherPowerOfTwo = MathUtils.nearestPowerOfTwo;
	 ...
	 * @returns {boolean}
	 */
	static closeTo(v1, v2, tolerance) {
	 ...
	 * @returns {Vector3}
	 */
	static barycentricInterpolation(t1, t2, t3, p) {
	...
	*/
	 ...
	 */
	static floatToHalfFloat = (function () {

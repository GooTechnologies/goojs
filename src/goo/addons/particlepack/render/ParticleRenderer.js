define([
	...
	// REVIEW: Should there be a base class for the ParticleRenderer and the TrailRenderer?
	...
	// REVIEW: Perhaps split into smaller methods
	ParticleRenderer.prototype.init = function (goo, simConf, settings, spriteAtlas, texture) {
		...
		entity.name = 'ParticleRenderer'; // REVIEW: should this name include an ID in case there are several renderers?

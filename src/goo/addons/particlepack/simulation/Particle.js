...
function (
	...
	Particle.prototype.reset = function () {
		...
		this.acceleration = 1;
		this.gravity = 0; // Limited to Y direction?
		this.rotation = 0;
		this.spinspeed = 0;
		this.spin = [[0, 1], [1, 0]];
	...
	Particle.prototype.defaultParticleUpdate = function (deduct) {
		...
		this.velocity.addDirect(0, this.gravity * deduct, 0);

		calcVec.set(this.velocity);
		calcVec.mulDirect(deduct, deduct, deduct);
		this.position.addVector(calcVec);
	};

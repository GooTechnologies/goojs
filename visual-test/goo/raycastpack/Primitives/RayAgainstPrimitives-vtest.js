require([
	...
	var hitCallback = function(hitResult) {
		...
		LRS.drawLine(location, normalEnd, LRS.AQUA);
	...
	var update = function(){
		...
		start.setDirect(Math.sin(world.time)*5-10,start.y,start.z);
		end.setDirect(Math.cos(world.time*1.2)*5+10,end.y,end.z);

define([
	'test/loaders/helpers/EntityConfig',
	'test/loaders/helpers/AnimationConfig',
	'test/loaders/helpers/MaterialConfig',
	'test/loaders/helpers/MeshConfig',
	'test/loaders/helpers/SceneConfig'
], function(
) {
	'use strict';
	var bundle = {};

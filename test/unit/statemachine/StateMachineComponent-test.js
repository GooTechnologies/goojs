define([
	...
	describe('StateMachineComponent', function () {
		...
		it('can transition on fixedUpdate', function () {
			...
			state1.addAction({
				...
				exit: function () {},
				update: function () {},
				fixedUpdate: function (proxy) { proxy.send('toSecond'); }
			});
			state1.setTransition('toSecond', 'second');
			...
			state2.addAction({
				...
				exit: function () {},
				update: function () {},
				fixedUpdate: function () { fixedUpdateCounter++; }
			});
			...
			// jump to second state
			stateMachineComponent.fixedUpdate();

			// second state update
			stateMachineComponent.fixedUpdate();

			expect(fixedUpdateCounter).toBe(1);
		});

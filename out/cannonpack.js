goo.CannonBoxColliderComponent = (function (
	Component,
	Box,
	Vector3
) {
...
})(goo.Component,goo.Box,goo.Vector3);
goo.CannonCylinderColliderComponent = (function (
	Component
) {
	'use strict';
...
goo.CannonDistanceJointComponent = (function (
	Component,
	_
) {
	'use strict';
...
})(goo.Component,goo.ObjectUtils);
goo.CannonPlaneColliderComponent = (function (
	Component
) {
	'use strict';
...
goo.CannonRigidbodyComponent = (function (
	Component,
	Quaternion,
	Vector3,
	Transform,
...
})(goo.Component,goo.Quaternion,goo.Vector3,goo.Transform,goo.Box,goo.Sphere,goo.Quad,goo.ObjectUtils);
goo.CannonSphereColliderComponent = (function (
	Component
) {
	'use strict';
...
goo.CannonSystem = (function (
	...
	return CannonSystem;
})(goo.System,goo.BoundingBox,goo.BoundingSphere,goo.Quaternion,goo.Transform,goo.Vector3,goo.ObjectUtils);
goo.CannonTerrainColliderComponent = (function (
	Component
) {
	'use strict';
...
define("goo/addons/cannonpack/CannonBoxColliderComponent", [], function () { return goo.CannonBoxColliderComponent; });
define("goo/addons/cannonpack/CannonCylinderColliderComponent", [], function () { return goo.CannonCylinderColliderComponent; });
define("goo/addons/cannonpack/CannonDistanceJointComponent", [], function () { return goo.CannonDistanceJointComponent; });
define("goo/addons/cannonpack/CannonPlaneColliderComponent", [], function () { return goo.CannonPlaneColliderComponent; });
define("goo/addons/cannonpack/CannonRigidbodyComponent", [], function () { return goo.CannonRigidbodyComponent; });
define("goo/addons/cannonpack/CannonSphereColliderComponent", [], function () { return goo.CannonSphereColliderComponent; });
define("goo/addons/cannonpack/CannonSystem", [], function () { return goo.CannonSystem; });
define("goo/addons/cannonpack/CannonTerrainColliderComponent", [], function () { return goo.CannonTerrainColliderComponent; });
}

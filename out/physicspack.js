...
goo.AbstractColliderComponent = (function (
	Component,
	Collider
) {
	'use strict';
...
})(goo.Component,goo.Collider);
goo.AbstractRigidBodyComponent = (function (
	Component,
	Vector3,
	Quaternion,
	Transform,
...
})(goo.Component,goo.Vector3,goo.Quaternion,goo.Transform,goo.SystemBus);
goo.BoxCollider = (function (
	Vector3,
	Collider
) {
	'use strict';
	...
	return BoxCollider;
})(goo.Vector3,goo.Collider);
goo.SphereCollider = (function (
	Collider
) {
	'use strict';
...
goo.MeshCollider = (function (
	...
	return MeshCollider;
})(goo.Collider,goo.Vector3);
goo.PlaneCollider = (function (
	Collider
) {
	'use strict';
...
})(goo.AbstractColliderComponent,goo.BoxCollider,goo.SphereCollider,goo.MeshCollider,goo.PlaneCollider,goo.CylinderCollider,goo.Collider,goo.Vector3,goo.Quaternion);
goo.PhysicsJoint = (function () {
	'use strict';
...
goo.BallJoint = (function (
	...
	return BallJoint;
})(goo.PhysicsJoint,goo.Vector3);
goo.HingeJoint = (function (
	PhysicsJoint,
	Vector3
) {
	'use strict';
...
})(goo.AbstractRigidBodyComponent,goo.Vector3,goo.Quaternion,goo.Transform,goo.BoxCollider,goo.SphereCollider,goo.CylinderCollider,goo.PlaneCollider,goo.MeshCollider,goo.BallJoint,goo.HingeJoint,goo.ColliderComponent);
goo.ColliderComponentHandler = (function (
	ComponentHandler,
	ColliderComponent,
	BoundingBox,
...
})(goo.ComponentHandler,goo.ColliderComponent,goo.BoundingBox,goo.ShapeCreatorMemoized,goo.rsvp,goo.ObjectUtils,goo.SphereCollider,goo.BoxCollider,goo.PlaneCollider,goo.CylinderCollider,goo.PhysicsMaterial);
goo.RigidBodyComponentHandler = (function (
	ComponentHandler,
	RigidBodyComponent,
	BoundingBox,
	ShapeCreatorMemoized,
...
})(goo.ComponentHandler,goo.RigidBodyComponent,goo.BoundingBox,goo.ShapeCreatorMemoized,goo.rsvp,goo.ObjectUtils,goo.Vector3);
goo.PhysicsBoxDebugShape = (function (
	MeshData
) {
	'use strict';
...
goo.PhysicsCylinderDebugShape = (function (
	MeshData
) {
	'use strict';
	...
	/**
	 * @return {PhysicsCylinderDebugShape} self for chaining
	 */
	...
	return PhysicsCylinderDebugShape;
})(goo.MeshData);
goo.PhysicsPlaneDebugShape = (function (
	MeshData
) {
	'use strict';
	...
	return PhysicsPlaneDebugShape;
})(goo.MeshData);
goo.PhysicsSphereDebugShape = (function (
	MeshData
) {
	'use strict';
	...
	return PhysicsSphereDebugShape;
})(goo.MeshData);
goo.AbstractPhysicsSystem = (function (
	System,
	SystemBus
) {
	'use strict';
...
goo.PhysicsDebugRenderSystem = (function (
	EntitySelection,
	System,
	SystemBus,
	Sphere,
...
})(goo.EntitySelection,goo.System,goo.SystemBus,goo.Sphere,goo.Box,goo.Cylinder,goo.PhysicsPlaneDebugShape,goo.PhysicsCylinderDebugShape,goo.PhysicsSphereDebugShape,goo.PhysicsBoxDebugShape,goo.SphereCollider,goo.BoxCollider,goo.CylinderCollider,goo.PlaneCollider,goo.MeshCollider,goo.Quaternion,goo.Vector3,goo.Transform,goo.Material,goo.ShaderLib,goo.Pool);
goo.PhysicsSystem = (function (
...
})(goo.AbstractPhysicsSystem,goo.RaycastResult,goo.RigidBodyComponent,goo.Vector3,goo.Quaternion,goo.EntityUtils,goo.Transform);
if (typeof require === "function") {
define("goo/addons/physicspack/PhysicsMaterial", [], function () { return goo.PhysicsMaterial; });
define("goo/addons/physicspack/RaycastResult", [], function () { return goo.RaycastResult; });
define("goo/addons/physicspack/colliders/Collider", [], function () { return goo.Collider; });
define("goo/addons/physicspack/components/AbstractColliderComponent", [], function () { return goo.AbstractColliderComponent; });
define("goo/addons/physicspack/components/AbstractRigidBodyComponent", [], function () { return goo.AbstractRigidBodyComponent; });
define("goo/addons/physicspack/colliders/BoxCollider", [], function () { return goo.BoxCollider; });
define("goo/addons/physicspack/colliders/SphereCollider", [], function () { return goo.SphereCollider; });
define("goo/addons/physicspack/colliders/MeshCollider", [], function () { return goo.MeshCollider; });
define("goo/addons/physicspack/colliders/PlaneCollider", [], function () { return goo.PlaneCollider; });
define("goo/addons/physicspack/colliders/CylinderCollider", [], function () { return goo.CylinderCollider; });
define("goo/addons/physicspack/components/ColliderComponent", [], function () { return goo.ColliderComponent; });
define("goo/addons/physicspack/joints/PhysicsJoint", [], function () { return goo.PhysicsJoint; });
define("goo/addons/physicspack/joints/BallJoint", [], function () { return goo.BallJoint; });
define("goo/addons/physicspack/joints/HingeJoint", [], function () { return goo.HingeJoint; });
define("goo/addons/physicspack/components/RigidBodyComponent", [], function () { return goo.RigidBodyComponent; });
define("goo/addons/physicspack/handlers/ColliderComponentHandler", [], function () { return goo.ColliderComponentHandler; });
define("goo/addons/physicspack/handlers/RigidBodyComponentHandler", [], function () { return goo.RigidBodyComponentHandler; });
define("goo/addons/physicspack/shapes/PhysicsBoxDebugShape", [], function () { return goo.PhysicsBoxDebugShape; });
define("goo/addons/physicspack/shapes/PhysicsCylinderDebugShape", [], function () { return goo.PhysicsCylinderDebugShape; });
define("goo/addons/physicspack/shapes/PhysicsPlaneDebugShape", [], function () { return goo.PhysicsPlaneDebugShape; });
define("goo/addons/physicspack/shapes/PhysicsSphereDebugShape", [], function () { return goo.PhysicsSphereDebugShape; });
define("goo/addons/physicspack/systems/AbstractPhysicsSystem", [], function () { return goo.AbstractPhysicsSystem; });
define("goo/addons/physicspack/systems/ColliderSystem", [], function () { return goo.ColliderSystem; });
define("goo/addons/physicspack/util/Pool", [], function () { return goo.Pool; });
define("goo/addons/physicspack/systems/PhysicsDebugRenderSystem", [], function () { return goo.PhysicsDebugRenderSystem; });
define("goo/addons/physicspack/systems/PhysicsSystem", [], function () { return goo.PhysicsSystem; });
}

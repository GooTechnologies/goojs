goo.calculateTriangleMeshShape = (function () {
	'use strict';
	/*global Ammo */
...
})(goo.EntityUtils,goo.Component,goo.Quaternion,goo.calculateTriangleMeshShape,goo.Box,goo.Quad,goo.Sphere,goo.Material,goo.ShaderLib,goo.BoundingBox,goo.BoundingSphere,goo.ObjectUtils);
goo.AmmoSystem = (function (
	System
) {
	'use strict';
	/*global Ammo */
...
define("goo/addons/ammopack/calculateTriangleMeshShape", [], function () { return goo.calculateTriangleMeshShape; });
define("goo/addons/ammopack/AmmoComponent", [], function () { return goo.AmmoComponent; });
define("goo/addons/ammopack/AmmoSystem", [], function () { return goo.AmmoSystem; });
}

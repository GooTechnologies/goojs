define(['goo/entities/components/TransformComponent', 'goo/renderer/MeshData', 'goo/loaders/JsonUtils', 'goo/entities/components/MeshDataComponent',
		...
		'goo/animation/JointChannel', 'goo/util/URLTools'], function(TransformComponent, MeshData, JsonUtils, MeshDataComponent,
	MeshRendererComponent, Material, TextureCreator, Shader, Joint, Skeleton, SkeletonPose, AnimationClip, JointChannel, URLTools) {
	"use strict";

...
define([ 'goo/entities/systems/System', 'goo/renderer/TextureCreator' ],
		function(System, TextureCreator) {
			...
			function updateTextures(material, renderer) {
				...
				for ( var i = 0; i < material.shader.textureCount; i++) {
					...
					// TODO: bind?
					context.texParameteri(getGLType(texture.variant, context),
							WebGLRenderingContext.TEXTURE_MAG_FILTER, getGLMagFilter(texture.magFilter, context));
					context.texParameteri(getGLType(texture.variant, context),
							WebGLRenderingContext.TEXTURE_MIN_FILTER, getGLMinFilter(texture.minFilter, context));
					...
					if (texture.variant === '2D') {
						...
						context.texParameteri(WebGLRenderingContext.TEXTURE_2D, WebGLRenderingContext.TEXTURE_WRAP_S,
								wrapS);
						context.texParameteri(WebGLRenderingContext.TEXTURE_2D, WebGLRenderingContext.TEXTURE_WRAP_T,
								wrapT);
			...
			function updateTexture(context, texture, unit) {
				...
				context.texImage2D(WebGLRenderingContext.TEXTURE_2D, 0, getGLInternalFormat(texture.format, context),
